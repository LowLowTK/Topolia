# AGENTS.md — Topolia.fr

> Fichier lu automatiquement par Codex à chaque ouverture de session.
...
Ce skill est pré-installé dans Codex. Ref : https://github.com/blader/humanizer
