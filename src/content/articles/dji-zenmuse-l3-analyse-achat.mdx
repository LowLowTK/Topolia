...
subtitle: 'Specs décryptées, comparatif L2 / M4E, coût réel du système et verdict terrain pour un géomètre.'
date: 2026-05-28
...
excerpt: "Je suis géomètre et j'hésite à investir dans le Zenmuse L3. Avant de sortir la CB, j'ai épluché toutes les specs, les tests indépendants et les retours terrain. Voici mon analyse honnête."
faq:
  - q: 'Le Zenmuse L3 est-il compatible avec le M300 ou le M350 ?'
    a: 'Non. Le Zenmuse L3 fonctionne exclusivement sur le Matrice 400 RTK, via son port nacelle E1. Si tu voles avec un M300 ou un M350, tu ne peux pas simplement acheter la nacelle : il te faut aussi le nouveau drone. Le budget upgrade devient donc un budget système complet.'
  - q: 'Combien coûte un système Zenmuse L3 complet ?'
    a: 'Compte entre 37 000 et 40 000 € TTC pour un système opérationnel. La nacelle L3 seule est à 14 878 €, le Matrice 400 RTK à 9 568 €, et le kit M400 + L3 complet tourne autour de 30 699 €. Ajoute la base GNSS D-RTK 3 (~5 000 €) et des batteries supplémentaires (~2 000 €).'
  - q: 'Quelle est la précision du Zenmuse L3 ?'
    a: "Le L3 annonce 3 cm de précision verticale et 4 cm horizontale en RMSE à 120 m, et 5 cm vertical à 300 m. Un test indépendant ASPRS sur terrain dur et plat a même mesuré 0,7 cm de RMSE vertical après correction, sans aucun point d'appui au sol, uniquement avec le RTK du M400."
  - q: 'Le Zenmuse L3 suffit-il pour le bornage ?'
    a: "Non, pas seul. Avec 4 cm horizontal à 120 m, le L3 est à la limite des tolérances cadastrales (2 à 5 cm), et à la limite ne suffit pas pour signer. Le workflow reste hybride : le L3 porte la topo détaillée d'ensemble, le GNSS RTK au sol détermine les coordonnées exactes des bornes."
  - q: 'Quelle différence entre le Zenmuse L3 et le L2 ?'
    a: 'Le L3 double la portée (950 m contre ~450 m), passe à 16 retours par impulsion contre 5, monte à 25 m/s et embarque deux caméras 100 MP contre une de 20 MP. Sa précision verticale gagne 1 cm (3 cm à 120 m). En contrepartie il pèse 1,60 kg et impose le Matrice 400 RTK.'
isPremium: false
isPublished: true
---
...
Depuis que DJI a annoncé le Zenmuse L3 en novembre 2025, il tourne dans ma tête. Je travaille déjà avec un [Matrice 4E pour mes relevés photogrammétriques](/articles/dji-matrice-4e-photogrammetrie/), et la question se pose : est-ce que ce [LiDAR](/glossaire/lidar/) longue portée change vraiment quelque chose pour un cabinet comme le mien ?
...
<CompareTable
  ...
  rows={[
    ...
    },
    {
      ...
      values: ['', '1,60 kg', 'Vs 0,93 kg pour le L2, dans les limites du M400'],
    },
    {
...
Si ton besoin reste en photogrammétrie, vérifie d'abord le [GSD attendu](/outils/calculateur-gsd-drone/) et le [volume de mission](/outils/calculateur-mission-drone/) avant de regarder une plateforme LiDAR lourde. Le saut de budget ne se justifie que si le terrain ou la végétation bloque vraiment la photo.
...
Pour un géomètre en zone rurale ou forestière, les [MNT](/glossaire/mnt/) sous bois sont enfin exploitables directement, sans interpolation hasardeuse.
...
<Callout type="warning">
  ...
  les tolérances cadastrales. Le L3 annonce 4 cm horizontal à 120 m (RMSE). C'est à la limite, et "à
  la limite" en bornage, ce n'est pas suffisant pour signer.
</Callout>
...
2. **GNSS [RTK](/glossaire/rtk/) au sol** → coordonnées exactes des bornes, pivots, tubes, cibles balisées
...
<Callout type="info">
  ...
  choix de confort. C'est une mise à niveau réglementaire et technique. La question n'est plus de
  savoir si tu le feras, mais quand.
</Callout>

<PullQuote>
  Je n'achète pas seulement un meilleur LiDAR. J'achète une plateforme qui a un avenir
  réglementaire, ce que mon M300 n'a plus.
</PullQuote>

Une fois le L3 commandé et livré, je ferai un vrai test terrain. Les nuages LAS/LAZ exportés depuis DJI Terra, je les ouvre et je les dessine directement dans [Topolia Desktop](/a-propos/), l'appli que je développe en parallèle de mon activité de géomètre. Si tu veux suivre ce test terrain à venir et les premiers retours sur le nuage L3, [abonne-toi à la newsletter](/newsletter/) : c'est là que je publierai les chiffres une fois le drone en main.
