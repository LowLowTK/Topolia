...
Le RTC360 a un avantage net : la fonction `Visual Inertial System` (VIS) qui pré-recale les stations en temps réel. Sur ce type de relevé répétitif, je gagne **30 % de temps terrain** vs le Faro.
